...
const testimonials = [
  ...
  },
  {
    id: 2,
    name: 'Tim Jones',
    role: 'Local Guide & Player',
    rating: 5,
    date: 'A year ago',
    text: 'We play indoor here and have been very happy with our experience! The fields are nice. Its reasonably priced. The programs are well run.',
  ...
  {
    id: 8,
    name: 'Fernando Javier Menendez',
    role: 'Local Guide',
    rating: 5,
    date: '2 years ago',
    text: 'Excellent place to go play soccer. Outdoor and indoor fields are available and in excellent condition. The dimensions of the fields are perfect for 6 to 7 players on each side.',
    avatar: '/testimonials/fernando.png',
  },
  {
    id: 9,
    name: 'Jeremy Brodovsky',
    role: 'Local Guide & Player',
    rating: 5,
    date: '2 years ago',
    text: 'Love it. Great Place for footy all ages. All year round so you dont have to worry about the weather!',
    avatar: '/testimonials/jeremy.png',
  },
];
